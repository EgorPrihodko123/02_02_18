...
private void checkOnRobotPart(Head head,Body body,Hand leftHand,Hand rightHand,Leg leftLeg, Leg rightLeg) {
    int count=0;
    if (this.head != null&&this.body!=null) {
        count++;
        head.robotCanThink();
    }
    if (this.leftHand != null && rightHand != null&&this.body!=null) {
        count++;
    ...
    if (this.leftLeg != null && rightLeg != null&&this.body!=null) {
        leftLeg.robotCanRun();
        count++;
    }
    if(count==3){
        System.out.println("Robot gotov");
    }
  }
}
